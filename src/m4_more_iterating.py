...
def run_test_count_items_bigger_than():
    ...
    expected = [4, 9]
    actual = [[(1, 4, 465, -24, -1435, 42, -24, -987, 324, -3), 1], [(-1234, -25, 5, -65, 245, 654, -789, 2, -56, -64, 654), -70]]
    for i in range(2):
        print()
        print('Test', i + 9, 'expected:', expected[i])
        print('     ',  ' ' * i, 'actual:  ', count_items_bigger_than(actual[i][0], actual[i][1]))
...
def run_test_sum_first_n():
    ...
    expected = [-989, -420]
    actual = [[(1, 4, 465, -24, -1435, 42, -24, -987, 324, -3), 5], [(-1234, -25, 5, -65, 245, 654, -789, 2, -56, -64, 654), 6]]
    for i in range(2):
        print()
        print('Test', i + 8, 'expected:', expected[i])
        print('     ', 'actual:  ', sum_first_n(actual[i][0], actual[i][1]))
